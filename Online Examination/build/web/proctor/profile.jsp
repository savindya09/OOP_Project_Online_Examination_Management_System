                                ...
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        ...
                                        <div class="card-body  p-2">
                                            <form action="../proctorupdate" method="post" role="form" class="text-start">
                                        <% 
                                            String id = (String) session.getAttribute("pid");
                                            ProctorModel proctor = new ProctorModel();
                                            ResultSet rs = proctor.dataProctor(id);
                                            if (rs != null) {
                                                if(rs.next()) { 
                                        %>
                                ...
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        ...
                                        <div class="card-body  p-3">
                                            <form action="../proctorupdatepassword" method="post" role="form" class="text-start">
