                                ...
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        ...
                                        <div class="card-body  p-2">
                                            <form action="../adminupdate" method="post" role="form" class="text-start">
                                        <% 
                                            String id = (String) session.getAttribute("aid");
                                            AdminModel a = new AdminModel();
                                            ResultSet rs = a.dataAdmin(id);
                                            if (rs != null) {
                                                if(rs.next()) { 
                                        %>
                                ...
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        ...
                                        <div class="card-body  p-3">
                                            <form action="../adminupdatepassword" method="post" role="form" class="text-start">
