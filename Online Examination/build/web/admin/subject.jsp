                                    ...
                                    <div class="card-body px-0 pb-2">
                                        <div class="table-responsive p-2">
                                            <table class="align-items-center mb-0" style="width: 100%">
                                                <thead>
                                                    <tr>
                                                        <th class="text-uppercase text-center align-items-center text-xs font-weight-bolder opacity-7" style="width: 80%">Subject</th>
                                                        <th class="text-uppercase text-center text-secondary text-xs font-weight-bolder opacity-7" style="width: 20%">Setting</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                     <% 
                                            SubjectModel a = new SubjectModel();
                                            ResultSet rs = a.getAllSubject();
                                            if (rs != null) {
                                                while(rs.next()) { 
                                        %>
                                                    <tr>
                                                        ...
                                                        <td class="align-right text-center">
                                                            <a href="editsubject.jsp?sid=<%=rs.getString("id") %>&sname=<%=rs.getString("name") %>" class="btn btn-link text-dark userIpx-3 mb-0" data-toggle="tooltip" data-original-title="Edit Batch"><i class="material-icons text-sm me-2">edit</i>
                                                                Edit
                                                            </a>
                                                        </td>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="card-body">
                                    <form action="../addsubject" method="post" role="form" class="text-start">
